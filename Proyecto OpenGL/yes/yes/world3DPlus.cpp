...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		lightPosLoc = glGetUniformLocation(shaderColor.ID, "light.position"); //Si voy a usar la misma luz uso la misma variable, si va depender de otra luz creo otra variables Ejemplo "lightPosLoc2"
