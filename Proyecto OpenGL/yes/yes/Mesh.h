...
public:
    ...
    /*  Functions  */
    // Constructor
    Mesh( vector<Vertex> vertices, vector<GLuint> indices, vector<Texture> textures, glm::vec3 materialAmbiente, glm::vec3 materialDifuso, glm::vec3 materialSpecular, GLfloat materialShininess)
    {
